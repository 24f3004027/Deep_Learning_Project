...
<div class="glass-card" style="padding: 15px 20px !important; margin-bottom: 20px !important;">
    <table style="width: 100%; border: none; margin: 0;">
        <tr style="background: none; border: none;">
            ...
            <td style="border: none; padding: 0; text-align: center; font-weight: 600; color: {text_color} !important; width: 30%;">🪪 ID Proof: <a href="https://l1nq.com/mkebd4a" target="_blank" style="color: {link_color} !important; font-weight: 700; text-decoration: none;">Click Here</a></td>
